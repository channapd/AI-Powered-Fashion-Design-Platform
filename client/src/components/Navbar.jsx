...
const Navbar = () => {
  ...
  const {userData, backendUrl, setUserData, setIsLoggedin, credit, setDesigns, setIsVerified, setSelectedDesign, setCredit, setIsViewHistory} = useContext(AppContent)
