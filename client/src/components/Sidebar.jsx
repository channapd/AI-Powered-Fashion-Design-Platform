...
const Sidebar = () => {
  ...
  return (
    <div className={`h-screen bg-[#2E5E4E] transition-all ease-in-out duration-300 overflow-y-scroll ${collapsed ? 'w-16' : 'w-64'}`}>
      <div className="flex justify-between items-center p-4">
        <div onClick={toggleSidebar} className="w-14 min-w-[1.25rem]">
